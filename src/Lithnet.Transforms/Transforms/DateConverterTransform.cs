namespace Lithnet.Transforms
{
    ...
    public class DateConverterTransform : Transform
    {
        ...
        {
            DateTime parsedDateTime = DateTime.ParseExact(value, GenericExtensions.ResourceManagementServiceDateFormat, CultureInfo.CurrentCulture, DateTimeStyles.None);
        ...
        {
            DateTime parsedDateTime = DateTime.ParseExact(value, GenericExtensions.ResourceManagementServiceDateFormatZeroedMilliseconds, CultureInfo.CurrentCulture, DateTimeStyles.None);
        ...
        private object GetDateTimeOutput(DateTime date)
        {
            switch (this.OutputDateType)
            {
                ...
                case DateType.FimServiceString:
                    return date.ToString(GenericExtensions.ResourceManagementServiceDateFormat);

                case DateType.FimServiceStringTruncated:
                    return date.ToString(GenericExtensions.ResourceManagementServiceDateFormatZeroedMilliseconds);
